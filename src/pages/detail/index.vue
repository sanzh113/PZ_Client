    ...
    <div class="container">
        ...
        <!-- 待服务 -->
          <div class="dzf" v-if="detailData.trade_state === '待服务'">
            ...
            <div class="text2">请在保持手机畅通，稍后专员与您联系</div>
          </div>
         <!-- 已完成 -->
          ...
          <div class="dzf" v-if="detailData.trade_state === '已取消'">
            ...
            <div class="text2">期待下次为您服务，如需帮助请咨询客服</div>
          </div>
...
// 把时间戳变成年月日 当遇到 client.name直接detailData[key]
...
onMounted(async ()=>{
    ...
    // console.log('route.query.oid',route.query.oid);
    // // 把后端返回的数据 放入到详情数据中
    ...
    // console.log('stateMap',detailData.trade_state,stateMap[detailData.trade_state])
